...
--notice in full outer join we dont need to specify the relation for dID
--but right and left we do need to specify , 
--right with rightR.id left with left_relaiton.id
create view answer as
select driver_id,r5,r4,r3,r2,r1
from r5 natural full outer join r4 natural full outer join 
r3 natural full outer join 
r2 natural full outer join r1 natural full outer join driver
